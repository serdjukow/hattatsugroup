...
<head>
<meta charset="UTF-8">
<title>Полтика конфиденциальности</title>
<link rel="stylesheet" type="text/css" href="politica_css.css"/>
</head>
<body>
<form>
...
<div class="layout">
		...
		отношении всей информации, которую сайт <strong>www.serdukov.eu</strong>, (далее – serdukov.eu) расположенный на 
		доменном имени <strong>serdukov.eu/</strong> (а также его субдоменах), может получить о Пользователе во время использования 
		сайта serdukov.eu/ (а также его субдоменов), его программ и его продуктов.</p>
		...
		на управление сайтом <strong>www.serdukov.eu</strong>,
		...
		<p>1.1.5. «Сайт <strong> www.serdukov.eu</strong>» - это совокупность связанных между собой веб-страниц, размещенных в сети Интернет по уникальному 
		адресу (URL): <strong>serdukov.eu/</strong>, а также его субдоменах.</p>

		<p>1.1.6. «Субдомены»  - это страницы или совокупность страниц, расположенные на доменах третьего уровня, 
		принадлежащие сайту www.serdukov.eu, а также другие временные страницы, внизу который указана контактная
		информация Администрации</p>
		
		<p>1.1.5. «Пользователь сайта <strong>www.serdukov.eu</strong> » (далее Пользователь) – лицо, имеющее доступ 
		к сайту <strong>www.serdukov.eu</strong>, посредством сети Интернет 
		и использующее информацию, материалы и продукты сайта <strong>www.serdukov.eu</strong>.</p>
		...
		<p>2.1. Использование сайта www.serdukov.eu Пользователем означает согласие с настоящей Политикой 
		...
		сайта www.serdukov.eu .</p>

		<p>2.3. Настоящая Политика конфиденциальности применяется к сайту www.serdukov.eu.
		serdukov.eu не контролирует и не несет ответственность за сайты третьих лиц, на которые Пользователь 
		может перейти по ссылкам, доступным на сайте www.serdukov.eu.</p>
		...
		регистрации на сайте www.serdukov.eu или при подписке на информационную e-mail рассылку.</p>
		
		<p>3.2. Персональные данные, разрешённые к обработке в рамках настоящей Политики конфиденциальности, предоставляются 
		Пользователем путём заполнения форм на сайте www.serdukov.eu и включают в себя следующую информацию:<br/>
		...
		<p>3.3. serdukov.eu защищает Данные, которые автоматически передаются при посещении страниц:<br/>
		- IP адрес<br/>
		...
		<p>3.3.1. Отключение cookies может повлечь невозможность доступа к частям сайта <?php echo www.serdukov.eu ?>, требующим 
		авторизации.</p>

		<p>3.3.2. serdukov.eu осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация 
		...
		4.1.1. Идентификации Пользователя, зарегистрированного на сайте www.serdukov.eu для его дальнейшей авторизации.<br/>

		4.1.2. Предоставления Пользователю доступа к персонализированным данным сайта www.serdukov.eu.<br/>

		4.1.3. Установления с Пользователем обратной связи, включая направление уведомлений, запросов, касающихся использования 
		сайта www.serdukov.eu, обработки запросов и заявок от Пользователя.<br/>

		4.1.4. Определения места нахождения Пользователя для обеспечения безопасности, предотвращения мошенничества.<br/>

		4.1.5. Подтверждения достоверности и полноты персональных данных, предоставленных Пользователем.<br/>

		4.1.6. Создания учетной записи для использования частей сайта www.serdukov.eu, если Пользователь дал согласие на 
		...
		сайта www.serdukov.eu, и давать согласие на их обработку.</p>
		...
		тексты и т. д.), к которой он может иметь доступ как к части сайта www.serdukov.eu, несет лицо, предоставившее 
		такую информацию.</p>
		
		<p>7.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта www.serdukov.eu, может 
		являться объектом интеллектуальной собственности, права на который защищены и принадлежат другим Пользователям, 
		партнерам или рекламодателям, которые размещают такую информацию на сайте www.serdukov.eu. <br />
		...
		сайте www.serdukov.eu) допускается их распространение при условии, что будет дана ссылка 
		на serdukov.eu.</p>
		...
		содержащихся на сайте www.serdukov.eu или передаваемых через него.</p>
		...
		сайте www.serdukov.eu, включая, но не ограничиваясь: информацию, защищенную авторским правом, без прямого 
		...
		<p>8.3. При не достижении соглашения спор будет передан на рассмотрение Арбитражного суда г. Moscow.</p>
		...
		<p>9.2. Новая Политика конфиденциальности вступает в силу с момента ее размещения на сайте www.serdukov.eu, если 
		...
		адресу: info@serdukov.eu</p>
		
		<p>9.4. Действующая Политика конфиденциальности размещена на странице по адресу http://serdukov.eu/politika.html</p>

		<p>Обновлено: 11 Мая 2019 года</p>
		<p>www.serdukov.eu</p>
	</div>	
	<div class="fixed">
		<a href="http://serdukov.eu/kontakt.php"> Вернуться назад</a>
		<ul>
		<li>
	
						<input type="hidden" name="type" value="">
			<input type="hidden" name="sitename" value="www.serdukov.eu">
			<input type="hidden" name="short_sitename" value="serdukov.eu">
			<input type="hidden" name="domain" value="serdukov.eu/">
			<input type="hidden" name="email" value="info@serdukov.eu">
			<input type="hidden" name="date" value="11 Мая 2019">
			<input type="hidden" name="time" value="1557589086">
			<input type="hidden" name="file" value="politica">
			<input type="hidden" name="footer" value="www.serdukov.eu">
		</form>
		</li>
		</ul>
	</div>
